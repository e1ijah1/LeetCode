...
class TicTacToe:
    ...
    def _is_win(self, mark):
        ...
        return (
            ...
            or mark == board[0][0] == board[1][0] == board[2][0]  # row 2
            or mark == board[0][1] == board[1][1] == board[2][1]  # column 0
            or mark == board[0][2] == board[1][2] == board[2][2]  # column 1
            or mark == board[0][0] == board[1][1] == board[2][2]  # column 2
